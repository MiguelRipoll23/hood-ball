// ../../node_modules/@mori2003/jsimgui/build/jsimgui-webgpu-ft.js
async function MainExport(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("jsimgui-webgpu-ft.wasm");
    }
    return new URL("jsimgui-webgpu-ft.wasm", import.meta.url).href;
  }
...
${invokerFnBody}`;
  ...
  var _emscripten_webgpu_get_device = () => {
    ...
    if (WebGPU.preinitializedDeviceId === void 0) {
  ...
  var _emscripten_webgpu_import_render_pass_encoder = (handle) => WebGPU.mgrRenderPassEncoder.create(JsValStore.get(handle));
  var ENV = {};
  ...
  var _wgpuDeviceCreateBindGroupLayout = (deviceId, descriptor) => {
    ...
    function makeTextureEntry(entryPtr) {
      ...
      if (!sampleTypeInt) return void 0;
      return {
  ...
  var _wgpuDeviceCreatePipelineLayout = (deviceId, descriptor) => {
    ...
    var desc = { label: void 0, bindGroupLayouts: bgls };
    var labelPtr = HEAPU32[descriptor + 4 >> 2];
    if (labelPtr) desc["label"] = UTF8ToString(labelPtr);
    var device = WebGPU.mgrDevice.get(deviceId);
  ...
  var generateRenderPipelineDesc = (descriptor) => {
    ...
    function makeVertexState(viPtr) {
      ...
      if (entryPointPtr) desc2["entryPoint"] = UTF8ToString(entryPointPtr);
      return desc2;
    }
...
var jsimgui_webgpu_ft_default = MainExport;
export {
  jsimgui_webgpu_ft_default as default
};
//# sourceMappingURL=jsimgui-webgpu-ft-7CZBZAMR.js.map
