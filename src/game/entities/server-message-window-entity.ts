...
export class ServerMessageWindowEntity extends CloseableWindowEntity {
  ...
  public getNext(): boolean { return this.next; }

  public openMessage(
    index: number, length: number, title: string, content: string, timestamp?: number,
  ): void {
    this.index = index;
    this.next = false;
  ...
  public override close(): void { this.next = true; }
  public closeAll(): void { this.next = false; super.close(); }
}
